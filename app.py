...
def main():
    load_dotenv()
    st.set_page_config(page_title="OLG Consumer Insight AI",
                       page_icon="📄")
    ...
    with st.sidebar:
        st.subheader("Consumer Insight PDFs")
        pdf_docs = st.file_uploader(
            "Upload all files here and click on 'Process'", accept_multiple_files=True)
